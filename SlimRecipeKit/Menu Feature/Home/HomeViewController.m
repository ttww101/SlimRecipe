...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"瘦身食谱";
...
- (void)setContainerViewController {
    SlimRecipeVC *vc1 = [SlimRecipeVC new];
...
- (NSArray<UIImage *> *)tabBarImages {
    return @[[UIImage imageNamed:@"down_button"],[UIImage imageNamed:@"down_button2"],[UIImage imageNamed:@"down_button2"]];
}

- (UIColor *)tabBarColor {
    return [UIColor colorWithRed:132.0/255.0 green:185.0/255.0 blue:203.0/255.0 alpha:1.0];
}
...
- (void)setupNavigationStyle {
    NavigationTheme *theme = [[NavigationTheme alloc]
                              ...
                              //bar color
                              barColor:[UIColor colorWithRed:132.0/255.0 green:185.0/255.0 blue:203.0/255.0 alpha:1.0]
                              //title font, size
